...
function GameMode:OnGameRulesStateChange(keys)
	...
	if new_state == DOTA_GAMERULES_STATE_GAME_IN_PROGRESS then
		...
		local point_tower_radiant_8 = Entities:FindByName(nil, "npc_dota_tower_radiant_8"):GetAbsOrigin()
		local point_tower_radiant_9 = Entities:FindByName(nil, "npc_dota_tower_radiant_9"):GetAbsOrigin()
		local point_tower_radiant_10 = Entities:FindByName(nil, "npc_dota_tower_radiant_10"):GetAbsOrigin()
		local point_tower_radiant_11 = Entities:FindByName(nil, "npc_dota_tower_radiant_11"):GetAbsOrigin()
		local point_tower_radiant_12 = Entities:FindByName(nil, "npc_dota_tower_radiant_12"):GetAbsOrigin()
		local point_tower_radiant_13 = Entities:FindByName(nil, "npc_dota_tower_radiant_13"):GetAbsOrigin()
		local point_tower_radiant_17 = Entities:FindByName(nil, "npc_dota_tower_radiant_17"):GetAbsOrigin()
		local point_tower_radiant_18 = Entities:FindByName(nil, "npc_dota_tower_radiant_18"):GetAbsOrigin()
		...
		CreateUnitByName("npc_dota_tower_radiant_060", point_tower_radiant_8, false, nil, nil, DOTA_TEAM_GOODGUYS)
		CreateUnitByName("npc_dota_tower_radiant_060", point_tower_radiant_9, false, nil, nil, DOTA_TEAM_GOODGUYS)
		CreateUnitByName("npc_dota_tower_radiant_060", point_tower_radiant_10, false, nil, nil, DOTA_TEAM_GOODGUYS)
		CreateUnitByName("npc_dota_tower_radiant_060", point_tower_radiant_11, false, nil, nil, DOTA_TEAM_GOODGUYS)
		CreateUnitByName("npc_dota_tower_radiant_060", point_tower_radiant_12, false, nil, nil, DOTA_TEAM_GOODGUYS)
		CreateUnitByName("npc_dota_tower_radiant_060", point_tower_radiant_13, false, nil, nil, DOTA_TEAM_GOODGUYS)
		CreateUnitByName("npc_dota_tower_radiant_060_2", point_tower_radiant_17, false, nil, nil, DOTA_TEAM_GOODGUYS)
		CreateUnitByName("npc_dota_tower_radiant_060_2", point_tower_radiant_18, false, nil, nil, DOTA_TEAM_GOODGUYS)

		-- Adds Dire towers to the map
		local point_tower_dire_1 = Entities:FindByName(nil, "npc_dota_tower_dire_1"):GetAbsOrigin()
		local point_tower_dire_2 = Entities:FindByName(nil, "npc_dota_tower_dire_2"):GetAbsOrigin()
		local point_tower_dire_3 = Entities:FindByName(nil, "npc_dota_tower_dire_3"):GetAbsOrigin()
		local point_tower_dire_4 = Entities:FindByName(nil, "npc_dota_tower_dire_4"):GetAbsOrigin()
		local point_tower_dire_5 = Entities:FindByName(nil, "npc_dota_tower_dire_5"):GetAbsOrigin()
		local point_tower_dire_6 = Entities:FindByName(nil, "npc_dota_tower_dire_6"):GetAbsOrigin()
		local point_tower_dire_7 = Entities:FindByName(nil, "npc_dota_tower_dire_7"):GetAbsOrigin()
		local point_tower_dire_8 = Entities:FindByName(nil, "npc_dota_tower_dire_8"):GetAbsOrigin()
		local point_tower_dire_9 = Entities:FindByName(nil, "npc_dota_tower_dire_9"):GetAbsOrigin()
		local point_tower_dire_10 = Entities:FindByName(nil, "npc_dota_tower_dire_10"):GetAbsOrigin()
		local point_tower_dire_11 = Entities:FindByName(nil, "npc_dota_tower_dire_11"):GetAbsOrigin()
		local point_tower_dire_12 = Entities:FindByName(nil, "npc_dota_tower_dire_12"):GetAbsOrigin()
		local point_tower_dire_13 = Entities:FindByName(nil, "npc_dota_tower_dire_13"):GetAbsOrigin()
		local point_tower_dire_17 = Entities:FindByName(nil, "npc_dota_tower_dire_17"):GetAbsOrigin()
		local point_tower_dire_18 = Entities:FindByName(nil, "npc_dota_tower_dire_18"):GetAbsOrigin()
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_1, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_2, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_3, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_4, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_5, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_6, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_7, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_8, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_9, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_10, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_11, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_12, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060", point_tower_dire_13, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060_2", point_tower_dire_17, false, nil, nil, DOTA_TEAM_BADGUYS)
		CreateUnitByName("npc_dota_tower_dire_060_2", point_tower_dire_18, false, nil, nil, DOTA_TEAM_BADGUYS)
