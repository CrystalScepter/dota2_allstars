modifier_item_tango_096 = class({})

-- Called when the modifier is created
function modifier_item_tango_096:OnCreated( kv )
...
function modifier_item_tango_096:OnIntervalThink()
