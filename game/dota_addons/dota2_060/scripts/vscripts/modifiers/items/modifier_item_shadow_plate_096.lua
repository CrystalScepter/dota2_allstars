modifier_item_shadow_plate_096 = class({})
LinkLuaModifier( "modifier_item_shadow_plate_096_corruption", "modifiers/items/modifier_item_shadow_plate_096_corruption", LUA_MODIFIER_MOTION_NONE )

-- Called when the modifier is created
function modifier_item_shadow_plate_096:OnCreated( kv )
...
function modifier_item_shadow_plate_096:DeclareFunctions()
	local funcs = {
...
function modifier_item_shadow_plate_096:GetModifierBonusStats_Strength( params )
	return self.bonus_strength
end

-- Returns the value for the property
function modifier_item_shadow_plate_096:GetModifierBonusStats_Agility( params )
	return self.bonus_agility
end

-- Returns the value for the property
function modifier_item_shadow_plate_096:GetModifierBonusStats_Intellect( params )
	return self.bonus_intelligence
end

-- Returns the value for the property
function modifier_item_shadow_plate_096:GetModifierPhysicalArmorBonus( params )
...
function modifier_item_shadow_plate_096:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

-- Prevents the modifier from showing up on the buff bar
function modifier_item_shadow_plate_096:IsHidden()
	return true
end
