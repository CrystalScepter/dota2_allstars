...
LinkLuaModifier( "modifier_item_spider_queen_060_poison", "modifiers/items/modifier_item_spider_queen_060_poison", LUA_MODIFIER_MOTION_NONE )
...
function modifier_item_spider_queen_060:OnAttacked( params )
	...
	params.target:AddNewModifier( self:GetParent(), self:GetAbility(), "modifier_item_spider_queen_060_poison", { duration = duration } )
end
