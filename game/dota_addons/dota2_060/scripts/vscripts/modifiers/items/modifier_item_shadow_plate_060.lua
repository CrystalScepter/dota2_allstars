...
LinkLuaModifier( "modifier_item_shadow_plate_060_corruption", "modifiers/items/modifier_item_shadow_plate_060_corruption", LUA_MODIFIER_MOTION_NONE )
...
function modifier_item_shadow_plate_060:OnAttacked( params )
	...
	params.target:AddNewModifier( self:GetParent(), self:GetAbility(), "modifier_item_shadow_plate_060_corruption", { duration = self.corruption_duration } )
end
