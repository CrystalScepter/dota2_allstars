modifier_item_spider_queen_060_poison = class({})

-- Called when the modifier is created
function modifier_item_spider_queen_060_poison:OnCreated(kv)
...
function modifier_item_spider_queen_060_poison:OnIntervalThink()
...
function modifier_item_spider_queen_060_poison:DeclareFunctions()
	local funcs = {
...
function modifier_item_spider_queen_060_poison:OnTooltip()
	return self.poison_damage
end

-- Turns the modifier into a debuff
function modifier_item_spider_queen_060_poison:IsDebuff()
	return true
end

-- Makes the modifier dispellable
function modifier_item_spider_queen_060_poison:IsPurgable()
	return true
end
