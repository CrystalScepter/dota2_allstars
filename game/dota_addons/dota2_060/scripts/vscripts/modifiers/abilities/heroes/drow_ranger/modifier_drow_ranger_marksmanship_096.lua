modifier_drow_ranger_marksmanship_096 = class({})

-- Called when the modifier is created
function modifier_drow_ranger_marksmanship_096:OnCreated()
...
function modifier_drow_ranger_marksmanship_096:DeclareFunctions()
	return {
...
function modifier_drow_ranger_marksmanship_096:OnAttackStart( keys )
	if IsServer() then
...
function modifier_drow_ranger_marksmanship_096:OnAttack(keys)
	if IsServer() then
		local attacker = keys.attacker
		local target = keys.target
...
function modifier_drow_ranger_marksmanship_096:OnAttackLanded(keys)
	if IsServer() then
		local attacker = keys.attacker
		local target = keys.target
...
function modifier_drow_ranger_marksmanship_096:IsHidden()
	return true
end