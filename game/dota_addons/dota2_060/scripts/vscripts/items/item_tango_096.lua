item_tango_096 = class({})
LinkLuaModifier( "modifier_item_tango_096", "modifiers/items/modifier_item_tango_096", LUA_MODIFIER_MOTION_NONE )

-- Applies the effect when the item is used
function item_tango_096:OnSpellStart()
	...
	caster:AddNewModifier( caster, self, "modifier_item_tango_096", nil )
