item_healing_potion_096 = class({})

-- Checks whether it's possible to use the item
function item_healing_potion_096:CastFilterResult()
...
function item_healing_potion_096:GetCustomCastError()
	return "#dota_hud_error_hero_is_full_health"
end

-- Applies the effect when the item is used
function item_healing_potion_096:OnSpellStart()
