item_mana_potion_060 = class({})

-- Checks whether it's possible to use the item
function item_mana_potion_060:CastFilterResult()
...
function item_mana_potion_060:GetCustomCastError()
	return "#dota_hud_error_hero_is_full_mana"
end

-- Applies the effect when the item is used
function item_mana_potion_060:OnSpellStart()
