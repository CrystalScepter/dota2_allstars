...
LinkLuaModifier(
	"modifier_item_wand_of_negation_060_thinker",
	"modifiers/items/modifier_item_wand_of_negation_060_thinker",
...
function item_wand_of_negation_060:OnSpellStart()
	...
	local particle_effect =
		ParticleManager:CreateParticle("particles/items2_fx/veil_of_discord.vpcf", PATTACH_ABSORIGIN, thinker)
