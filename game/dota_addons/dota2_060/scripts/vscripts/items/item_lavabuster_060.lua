...
LinkLuaModifier( "modifier_item_lavabuster_060", "modifiers/items/modifier_item_lavabuster_060", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_item_lavabuster_060_stun", "modifiers/items/modifier_item_lavabuster_060_stun", LUA_MODIFIER_MOTION_NONE )
