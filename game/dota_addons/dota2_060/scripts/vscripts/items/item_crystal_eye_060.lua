...
LinkLuaModifier(
	"modifier_item_crystal_eye_060_thinker",
	"modifiers/items/modifier_item_crystal_eye_060_thinker",
...
function item_crystal_eye_060:OnSpellStart()
	...
	local explosion_particle =
		ParticleManager:CreateParticle("particles/items_fx/dust_of_appearance.vpcf", PATTACH_ABSORIGIN, thinker)
