...
LinkLuaModifier( "modifier_drow_ranger_sneak_attack_060", "modifiers/abilities/heroes/drow_ranger/modifier_drow_ranger_sneak_attack_060", LUA_MODIFIER_MOTION_NONE )
