item_wand_of_negation_096 = class({})
LinkLuaModifier( "modifier_item_wand_of_negation_096_thinker", "modifiers/items/modifier_item_wand_of_negation_096_thinker", LUA_MODIFIER_MOTION_NONE )

-- Applies the effect when the item is used
function item_wand_of_negation_096:OnSpellStart()
	...
	local thinker = CreateModifierThinker( caster, self, "modifier_item_wand_of_negation_096_thinker", nil, target_position, caster:GetTeamNumber(), false )
