drow_ranger_sneak_attack_096 = class({})
LinkLuaModifier( "modifier_drow_ranger_sneak_attack_096", "modifiers/abilities/heroes/drow_ranger/modifier_drow_ranger_sneak_attack_096", LUA_MODIFIER_MOTION_NONE )

-- Applies the effect when the spell is used
function drow_ranger_sneak_attack_096:OnSpellStart()
	...
	Timers:CreateTimer( fade_time, function() 
		...
		local particle_invisibility_start = ParticleManager:CreateParticle( particle_invisibility, PATTACH_ABSORIGIN, caster )
		...
		caster:AddNewModifier( caster, self, "modifier_drow_ranger_sneak_attack_096", { duration = duration } )
	end )
end
