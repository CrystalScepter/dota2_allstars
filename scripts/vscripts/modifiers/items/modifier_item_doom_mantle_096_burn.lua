modifier_item_doom_mantle_096_burn = class({})

-- Called when the modifier is created
function modifier_item_doom_mantle_096_burn:OnCreated( kv )
...
function modifier_item_doom_mantle_096_burn:OnIntervalThink()
	
	-- Finds the enemy units within the aura radius
	local enemies = FindUnitsInRadius( self:GetCaster():GetTeamNumber(), self:GetParent():GetAbsOrigin(), nil, self.aura_radius, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_CREEP, 0, 0, false )
