modifier_item_spider_queen_096 = class({})
LinkLuaModifier( "modifier_item_spider_queen_096_poison", "modifiers/items/modifier_item_spider_queen_096_poison", LUA_MODIFIER_MOTION_NONE )
...
function modifier_item_spider_queen_096:DeclareFunctions()
	local funcs = {
...
function modifier_item_spider_queen_096:GetModifierBonusStats_Strength( params )
	return self.bonus_strength
end

-- Returns the value for the property
function modifier_item_spider_queen_096:GetModifierBonusStats_Agility( params )
	return self.bonus_agility
end

-- Returns the value for the property
function modifier_item_spider_queen_096:GetModifierBonusStats_Intellect( params )
	return self.bonus_intelligence
end

-- Applies the effect upon landing an attack
function modifier_item_spider_queen_096:OnAttacked( params )
	...
	params.target:AddNewModifier( self:GetParent(), self:GetAbility(), "modifier_item_spider_queen_096_poison", { duration = duration } )
end

-- Allows the modifier to stack
function modifier_item_spider_queen_096:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

-- Prevents the modifier from showing up on the buff bar
function modifier_item_spider_queen_096:IsHidden()
	return true
end
